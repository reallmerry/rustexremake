...
public class SegmentHeader {
    ...
    private int[] decodeScalar(String name, InputStream in, BHSDCodec codec, int n2) throws IOException, Pack200Exception {
        this.segment.log(2, "Parsed #" + name + " (" + n2 + ")");
        return codec.decodeInts(n2, in);
    }
    ...
    public void read(InputStream in) throws IOException, Error, Pack200Exception {
        ...
        for (int m2 = 0; m2 < magic.length; ++m2) {
            if (word[m2] == magic[m2]) continue;
