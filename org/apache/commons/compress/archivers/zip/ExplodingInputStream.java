...
implements InputStreamStatistics {
    ...
    private void init() throws IOException {
        if (this.bits == null) {
            try (CountingInputStream i2 = new CountingInputStream(new CloseShieldFilterInputStream(this.in));){
                if (this.numberOfTrees == 3) {
                    this.literalTree = BinaryTree.decode(i2, 256);
                }
                this.lengthTree = BinaryTree.decode(i2, 64);
                this.distanceTree = BinaryTree.decode(i2, 64);
                this.treeSizes += i2.getBytesRead();
            }
