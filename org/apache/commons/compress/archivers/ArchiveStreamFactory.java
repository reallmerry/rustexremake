...
implements ArchiveStreamProvider {
    ...
    public static String detect(InputStream in) throws ArchiveException {
        ...
        try {
            ...
            throw new ArchiveException("IOException while reading signature.", e2);
        }
        ...
        try (TarArchiveInputStream tais = new TarArchiveInputStream(new ByteArrayInputStream(tarHeader));){
            if (!tais.getNextTarEntry().isCheckSumOK()) throw new ArchiveException("No Archiver found for the stream signature");
            String string = TAR;
            return string;
